...
export default function EditDistancePage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-8">
        <h1 className="text-4xl font-bold neon-text-green mb-2">Edit Distance</h1>
        <p className="text-gray-400">Computes the minimum edits needed to convert one string into another.</p>
      </div>
